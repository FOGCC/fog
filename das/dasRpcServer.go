...
var (
	rpcStoreRequestGauge      = metrics.NewRegisteredGauge("fog/das/rpc/store/requests", nil)
	rpcStoreSuccessGauge      = metrics.NewRegisteredGauge("fog/das/rpc/store/success", nil)
	rpcStoreFailureGauge      = metrics.NewRegisteredGauge("fog/das/rpc/store/failure", nil)
	rpcStoreStoredBytesGauge  = metrics.NewRegisteredGauge("fog/das/rpc/store/bytes", nil)
	rpcStoreDurationHistogram = metrics.NewRegisteredHistogram("fog/das/rpc/store/duration", nil, metrics.NewBoundedHistogramSample())
)
