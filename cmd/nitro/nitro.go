...
import (
	...
	"github.com/FOGCC/fog/cmd/conf"
	"github.com/FOGCC/fog/cmd/genericconf"
	"github.com/FOGCC/fog/cmd/util"
	"github.com/FOGCC/fog/cmd/util/confighelpers"
	"github.com/FOGCC/fog/fognode"
	_ "github.com/FOGCC/fog/nodeInterface"
	"github.com/FOGCC/fog/staker"
	"github.com/FOGCC/fog/util/colors"
	"github.com/FOGCC/fog/util/headerreader"
	"github.com/FOGCC/fog/util/signature"
	"github.com/FOGCC/fog/util/stopwaiter"
	"github.com/FOGCC/fog/validator/valnode"
)
...
func mainImpl() int {
	...
	log.Info("Running FOG node", "revision", vcsRevision, "vcs.time", vcsTime)
...
func applyFOGOneParameters(k *koanf.Koanf) error {
	return k.Load(confmap.Provider(map[string]interface{}{
		...
		"node.forwarding-target":             "https://fog1.FOG.io/rpc",
		"node.feed.input.url":                "wss://fog1.FOG.io/feed",
...
func applyFOGNovaParameters(k *koanf.Koanf) error {
	return k.Load(confmap.Provider(map[string]interface{}{
		...
		"node.forwarding-target":                                 "https://nova.FOG.io/rpc",
		"node.feed.input.url":                                    "wss://nova.FOG.io/feed",
		"node.data-availability.enable":                          true,
		"node.data-availability.rest-aggregator.enable":          true,
		"node.data-availability.rest-aggregator.online-url-list": "https://nova.FOG.io/das-servers",
...
func applyFOGRollupGoerliTestnetParameters(k *koanf.Koanf) error {
	return k.Load(confmap.Provider(map[string]interface{}{
		...
		"node.forwarding-target":             "https://goerli-rollup.FOG.io/rpc",
		"node.feed.input.url":                "wss://goerli-rollup.FOG.io/feed",
...
func applyFOGRollupRinkebyTestnetParameters(k *koanf.Koanf) error {
	return k.Load(confmap.Provider(map[string]interface{}{
		"persistent.chain":                   "rinkeby-fog",
		"node.forwarding-target":             "https://rinkeby.FOG.io/rpc",
		"node.feed.input.url":                "wss://rinkeby.FOG.io/feed",
