...
func (con *fogSys) fogOSVersion(c ctx, evm mech) (huge, error) {
	version := new(big.Int).SetUint64(55 + c.State.fogOSVersion()) // FOG starts at version 56
	return version, nil
}

// GetStorageGasAvailable returns 0 since FOG has no concept of storage gas
