 ...
 *  This is a cute trick to allow an FOG node to provide data without us having to implement additional RPCs
 */
interface NodeInterface {
    ...
    // @notice Returns the first block produced using the FOG codebase
