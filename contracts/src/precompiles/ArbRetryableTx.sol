 ...
 * @notice Precompiled contract in every FOG chain for retryable transaction related data retrieval and interactions. Exists at 0x000000000000000000000000000000000000006e
 */
interface fogRetryableTx {
    ...
    /// @dev DEPRECATED in favour of new RedeemScheduled event after the fog upgrade
