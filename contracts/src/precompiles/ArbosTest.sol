...
/// @notice This exists for historical reasons. Pre-FOG, `fogosTest` had additional methods only the zero address could call.
/// These have been removed since users don't use them and calls to missing methods revert.
/// Precompiled contract that exists in every FOG chain at 0x0000000000000000000000000000000000000069.
interface fogosTest {
