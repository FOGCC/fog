...
/// @notice These methods have been adjusted to account for FOG's heavy use of calldata compression.
/// Of note to end-users, we no longer make a distinction between non-zero and zero-valued calldata bytes.
/// Precompiled contract that exists in every FOG chain at 0x000000000000000000000000000000000000006c.
