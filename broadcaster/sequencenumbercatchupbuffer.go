...
var (
	confirmedSequenceNumberGauge = metrics.NewRegisteredGauge("fog/sequencenumber/confirmed", nil)
	cachedMessagesSentHistogram  = metrics.NewRegisteredHistogram("fog/feed/clients/cache/sent", nil, metrics.NewBoundedHistogramSample())
)
