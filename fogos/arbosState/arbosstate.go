...
import (
	...
	"github.com/FOGCC/fog/fogos/addressSet"
	"github.com/FOGCC/fog/fogos/addressTable"
	"github.com/FOGCC/fog/fogos/blockhash"
	"github.com/FOGCC/fog/fogos/burn"
	"github.com/FOGCC/fog/fogos/l1pricing"
	"github.com/FOGCC/fog/fogos/l2pricing"
	"github.com/FOGCC/fog/fogos/merkleAccumulator"
...
// Returns a list of precompiles that only appear in FOG chains (i.e. fogOS precompiles) at the genesis block
