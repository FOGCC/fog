...
// To avoid creating new RPC methods for client-side tooling, fog Geth's InterceptRPCMessage() hook provides
...
func (n NodeInterface) GasEstimateComponents(
	...
	totalRaw, err := FOG.EstimateGas(context, backend, args, block, gasCap)
	if err != nil {
		return 0, 0, nil, nil, err
	}
