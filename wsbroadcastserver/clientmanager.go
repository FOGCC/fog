...
var (
	clientsCurrentGauge               = metrics.NewRegisteredGauge("fog/feed/clients/current", nil)
	clientsConnectCount               = metrics.NewRegisteredCounter("fog/feed/clients/connect", nil)
	clientsDisconnectCount            = metrics.NewRegisteredCounter("fog/feed/clients/disconnect", nil)
	clientsTotalSuccessCounter        = metrics.NewRegisteredCounter("fog/feed/clients/success", nil)
	clientsTotalFailedRegisterCounter = metrics.NewRegisteredCounter("fog/feed/clients/failed/register", nil)
	clientsTotalFailedUpgradeCounter  = metrics.NewRegisteredCounter("fog/feed/clients/failed/upgrade", nil)
	clientsTotalFailedWorkerCounter   = metrics.NewRegisteredCounter("fog/feed/clients/failed/worker", nil)
	clientsDurationHistogram          = metrics.NewRegisteredHistogram("fog/feed/clients/duration", nil, metrics.NewBoundedHistogramSample())
)
