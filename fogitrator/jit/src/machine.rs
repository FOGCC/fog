...
pub fn create(opts: &Opts, env: WasmEnv) -> (Instance, FunctionEnv<WasmEnv>, Store) {
    ...
    let imports = imports! {
        "go" => {
            ...
            "github.com/FOGCC/fog/wavmio.getGlobalStateBytes32" => func!(wavmio::get_global_state_bytes32),
            "github.com/FOGCC/fog/wavmio.setGlobalStateBytes32" => func!(wavmio::set_global_state_bytes32),
            "github.com/FOGCC/fog/wavmio.getGlobalStateU64" => func!(wavmio::get_global_state_u64),
            "github.com/FOGCC/fog/wavmio.setGlobalStateU64" => func!(wavmio::set_global_state_u64),
            "github.com/FOGCC/fog/wavmio.readInboxMessage" => func!(wavmio::read_inbox_message),
            "github.com/FOGCC/fog/wavmio.readDelayedInboxMessage" => func!(wavmio::read_delayed_inbox_message),
            "github.com/FOGCC/fog/wavmio.resolvePreImage" => func!(wavmio::resolve_preimage),

            "github.com/FOGCC/fog/fogcompress.brotliCompress" => func!(fogcompress::brotli_compress),
            "github.com/FOGCC/fog/fogcompress.brotliDecompress" => func!(fogcompress::brotli_decompress),
        },
    };
